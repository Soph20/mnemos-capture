    ...
    <main className="min-h-dvh flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-xs space-y-4">
        ...
        <a
          ...
          onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = "#1054b4"; }}
          onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = "#1c74d8"; }}
        >
